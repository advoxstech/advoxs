...
- Pendência (Etapa 3, ainda não iniciada): painel (`apps/web`) pra listar/criar/editar agentes, escolher o agente no upload de KB, e um seletor de "compartilhar arquivo com outros agentes" (a API já suporta N:N, o padrão de UX é direcionar por padrão a 1 agente).
