...
import app.email_notifications as email_notifications_module
from app.email_notifications import send_tenant_out_of_credits_notification

RAN_OUT_AT = datetime(2026, 8, 14, 12, 0, tzinfo=UTC)
...
class TestSendTenantOutOfCreditsNotification:
    async def test_pula_envio_quando_gmail_nao_configurado(self, monkeypatch) -> None:
        ...
        await send_tenant_out_of_credits_notification("Escritório X", RAN_OUT_AT)
