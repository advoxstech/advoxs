...
# agent_knowledge_base_files não tem coluna tenant_id própria (só FKs pra
# agents/knowledge_base_files, ambas já isoladas por RLS) — só "agents"
# recebe a policy genérica abaixo; ver bloco logo após o loop.
TENANT_SCOPED_TABLES = ["agents"]
