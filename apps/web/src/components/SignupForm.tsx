            ...
            return (
              <label
                ...
                className={`relative flex cursor-pointer items-center gap-3.5 rounded-2xl border bg-surface px-4 py-4 transition-colors ${
                  active
                    ? "border-auth-accent ring-4 ring-auth-accent/15"
              ...
              >
                ...
                />
                <span
                  className={`grid h-5 w-5 flex-none place-items-center rounded-full border peer-focus-visible:ring-2 peer-focus-visible:ring-auth-accent peer-focus-visible:ring-offset-2 ${
                    active ? "border-auth-accent" : "border-line"
                  }`}
                >
                  <span
                    className={`h-2.5 w-2.5 rounded-full bg-auth-accent transition-transform ${
